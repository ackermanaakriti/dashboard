...
import BalanceSheetPdfView from './BalanceSheetPdfVeiw';
import BalanceSheetWebView from './BalanceSheetwebView';


const BalanceSheetReportMain = () => {
    ...
    const handleDownload = async () => {
        const blob = await pdf(<BalanceSheetPdfView startDate={startDate} endDate={endDate} tableData={tableData}/>).toBlob();
    ...
    return (
        ...
        <div className='pb-[50px]'>
            <div className='w-full pb-[20px] border-b-[1px] border-b-[#ddd] border-b-solid'>
                ...
                {showWebView &&   <BalanceSheetWebView tableData={tableData} endDate={endDate} startDate={startDate}/>}
                </div>
...
export default BalanceSheetReportMain;
